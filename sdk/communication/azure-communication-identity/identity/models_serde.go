...
// MarshalJSON implements the json.Marshaller interface for type CommunicationIdentityAccessToken.
func (c CommunicationIdentityAccessToken) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "expiresOn", c.ExpiresOn)
	populate(objectMap, "token", c.Token)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CommunicationIdentityAccessToken.
func (c *CommunicationIdentityAccessToken) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "expiresOn":
				err = unpopulateTimeRFC3339(val, "ExpiresOn", &c.ExpiresOn)
				delete(rawMsg, key)
		case "token":
...
// MarshalJSON implements the json.Marshaller interface for type CommunicationIdentityAccessTokenRequest.
func (c CommunicationIdentityAccessTokenRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CommunicationIdentityAccessTokenRequest.
func (c *CommunicationIdentityAccessTokenRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CommunicationIdentityAccessTokenResult.
func (c CommunicationIdentityAccessTokenResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CommunicationIdentityAccessTokenResult.
func (c *CommunicationIdentityAccessTokenResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CommunicationIdentityCreateRequest.
func (c CommunicationIdentityCreateRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CommunicationIdentityCreateRequest.
func (c *CommunicationIdentityCreateRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
